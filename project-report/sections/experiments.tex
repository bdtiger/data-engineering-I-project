...
\textbf{Analysis:} Weak scaling failed to maintain constant time, showing ~21\% increase in runtime. This degradation highlights the significant ``coordination tax'' required to manage larger datasets across multiple nodes, primarily due to increased network latency during Spark's shuffle phase and non-linear I/O performance in the virtualized HDFS environment.
